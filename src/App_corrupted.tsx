...
function App() {
    ...
    { name:         {/* Fun Stats Section */}
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            ].map((stat, index) => (, level: 95, delay: 0 },
  ...
  const projects = [
    {
      title: 'Saku Sultan - Digital Wallet',
      description: 'Aplikasi dompet digital lengkap dengan fitur pembelian pulsa, pembayaran tagihan, dan manajemen saldo seperti GoPay.',
      technologies: ['React', 'Node.js', 'TypeScript', 'MySQL', 'Express'],
      githubUrl: 'https://github.com/fachri-rasyidi/saku-sultan',
      demoUrl: 'https://saku-sultan-demo.vercel.app'
    },
    {
      ...
      technologies: ['Node.js', 'Python', 'TensorFlow', 'MongoDB', 'Socket.io'],
      githubUrl: 'https://github.com/fachri-rasyidi/autocs-chatbot'
    },
    {
      title: 'Be Rich - MLM Platform',
      description: 'Platform komunitas bisnis berbasis MLM dengan sistem diskusi, manajemen anggota, dan tracking jaringan.',
      technologies: ['React', 'Node.js', 'TypeScript', 'PostgreSQL', 'Redis'],
      githubUrl: 'https://github.com/fachri-rasyidi/be-rich-platform',
      demoUrl: 'https://be-rich-demo.netlify.app'
    },
    {
      ...
      technologies: ['React', 'Node.js', 'MongoDB', 'WebSocket', 'Tailwind CSS'],
    ...
    },
    {
      ...
      technologies: ['React', 'Python', 'TensorFlow', 'Node.js', 'MySQL'],
      // githubUrl: 'https://github.com/fachri-rasyidi/lab-app-ai',
      demoUrl: 'https://lab.frasydi.site'
    },
    {
      title : "Kamus Bahasa Bugis - Fullstack Developer",
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { number: '∞', label: 'Learning Enthusiasm', icon: '🎓' }
            ].map((stat, index) => (
          ...
          <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-slate-600 transition-all duration-500">
            ...
            <div className="relative">
              <p className="text-gray-300 mb-6 text-lg">
                Interested in collaborating or discussing opportunities? Let's connect and build something great together.
              </p>
      ...
      <footer className="relative bg-slate-800/90 backdrop-blur-sm border-t border-slate-700 py-8 mt-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <p className="text-gray-400">
            &copy; 2025 Muhammad Fachri Rasyidi. Built with passion and dedication.
          </p>
